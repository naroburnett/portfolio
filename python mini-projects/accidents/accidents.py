...
def main():
    try:
        ...
        with open(filename, "rt") as text_file:
            ...
            #assert 0 <= perc_reduc <= 100
            if 0 > perc_reduc:
                raise ValueError(f'{perc_reduc} is to low. Please enter a value between 0 and 100') 
                   
            elif 100 < perc_reduc:
                raise ValueError(f'{perc_reduc} is to high. Please enter a value between 0 and 100')
            else:
                print()
        ...
        print("You entered an invalid integer for the percent reduction.")
        print("Run the program again and enter a correct integer")
